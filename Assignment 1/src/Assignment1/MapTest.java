...
public class MapTest {
	...
	public void testFindPath3() {
		...
		System.out.println( toBorder(actualPath, n1, n2));
		System.out.println(findDuplication(actualPath));
		System.out.println(isPathCorrect(actual, startX, startY, destX, destY));
